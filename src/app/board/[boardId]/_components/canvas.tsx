...
import { colorToCSS, connectionIdToColor, findIntersectingLayersWithRectangle, penPointsToLayer, pointerEventToCanvasPoint, resizeBounds } from '@/lib/utils'
import { LiveObject } from "@liveblocks/client"
import { LayerPreview } from "./layer-preview"
import { SelectionBox } from "./selection-box"
import { SelectionTools } from "./selection-tools"
import { Path } from "./path"
import { useDisableScrollBounce } from "@/hooks/use-disbale-scroll-bounce"
...
function Canvas({ boardId }: CanvasProps) {
    ...
    const insertPath = useMutation((
        ...
        liveLayers.set(
            id,
            new LiveObject(penPointsToLayer(
                pencilDraft,
                lastUsedColor
            ))
        );
